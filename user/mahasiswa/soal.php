...
// $survey_kategori_id = isset($_GET['survey_kategori_id']); // by kategori soal
...
<head>
    ...
    <style>
        ...
        .header {
            background: url('../../assets/images/gambar-header.jpeg') no-repeat;
...
<div class="container mt-0 mb-4">
    <div class="survey-container mx-auto col-md-8">
        <h4 class="text-center mb-4">Survey Mahasiswa</h4>
