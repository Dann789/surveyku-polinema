...
class Profile {
    ...
    public function getProfileData() {
        $query = "SELECT first_name, last_name, nim, email, prodi, phone_number, tahun_lulus, country, city, picture FROM p_alumni WHERE user_id = ?";
    ...
    public function updateProfileData($data) {
        ...
        $query = "UPDATE p_alumni SET " . implode(', ', $fields) . " WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateProfilePicture($picturePath) {
        ...
        $query = "UPDATE p_alumni SET picture = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateAlamat($country, $city) {
        ...
        $query = "UPDATE p_alumni SET country = ?, city = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($action) {
        case 'updateProfile':
            if (isset($_POST['first_name']) || isset($_POST['last_name']) || isset($_POST['nim']) 
            || isset($_POST['email']) || isset($_POST['prodi']) || isset($_POST['phone_number']) || isset($_POST['tahun_lulus']) ){
                $profileData = [];
                ...
                if (isset($_POST['tahun_lulus'])) $profileData['tahun_lulus'] = $_POST['tahun_lulus'];
        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="card-body d-flex flex-column justify-content-center text-start">
                        ...
                        <p class=" role fw-light"><?php echo htmlspecialchars($profileData['nim'] ?? ''); ?></p>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <p class="fw-medium"><?php echo htmlspecialchars($profileData['tahun_lulus'] ?? ''); ?></p>
                                </div>
                                <div class="col-4">
                                    <p class="identity mb-2">Prodi</p>
                                    <p class="fw-medium"><?php echo htmlspecialchars($profileData['prodi'] ?? ''); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="" id="formEditPicture" enctype="multipart/form-data" method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group position-relative mb-3">
                                        <label for="mahasiswa" class="mb-1 text-secondary">Alumni</label>
                                    </div>
                                    <div class="form-group position-relative mb-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" id="formEditProfil" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group position-relative mb-3">
                                <label for="tahun_lulus" class="mb-1 text-secondary">Tahun Lulus</label>
                                <input type="text" class="form-control border-0 border-bottom rounded-0" id="tahun_lulus" name="tahun_lulus" value="<?php echo htmlspecialchars($profileData['tahun_lulus'] ?? ''); ?>">
                            </div>
                            <div class="form-group position-relative mb-3">
