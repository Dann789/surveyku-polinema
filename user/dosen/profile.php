...
class Profile {
    ...
    public function getProfileData() {
        $query = "SELECT first_name, last_name, nip, email, unit, phone_number, country, city, picture FROM p_dosen WHERE user_id = ?";
    ...
    public function updateProfileData($data) {
        ...
        $query = "UPDATE p_dosen SET " . implode(', ', $fields) . " WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateProfilePicture($picturePath) {
        ...
        $query = "UPDATE p_dosen SET picture = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateAlamat($country, $city) {
        ...
        $query = "UPDATE p_dosen SET country = ?, city = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($action) {
        case 'updateProfile':
            if (isset($_POST['first_name']) || isset($_POST['last_name']) || isset($_POST['unit']) 
        ...
        break;
            ...
            case 'updateProfilePicture':
                ...
                if (isset($_POST['nip'])) {
                    $profile->updateProfileData(['nip' => $_POST['nip']]);
                }
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="card border-black rounded-4 d-flex flex-row justify-content-center align-items-center mx-5 my-4 pt-lg-2 ps-4 pe-5">
                    ...
                    <!-- <img src="../../assets/images/photo-profile2.jpeg" alt="profile" class="rounded-circle me-xl-5 mb-2" width="98px" height="98px"> -->
                ...
                <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                    <div class="modal-content">
                        <div class="modal-body d-flex justify-content-between gap-1">
                            ...
                            <input type="hidden" name="id_dosen" value="<?php echo htmlspecialchars($profileData['id_dosen'] ?? ''); ?>">
                            <div class="row mb-3">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group position-relative mb-3">
                                        <label for="nip" class="mb-1 text-secondary">NIP</label>
                                        <input type="text" name="nip" class="form-control border-0 border-bottom rounded-0" id="nip" value="<?php echo htmlspecialchars($profileData['nip'] ?? ''); ?>">
                                    </div>
                                    <div class="form-group position-relative mb-3">
