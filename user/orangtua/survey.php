...
class SurveyOrtu
{
    ...
    public function getSurveysForOrtu()
    {
        $query = "SELECT survey_kategori_id, survey_judul, survey_deskripsi, background_pic FROM " . $this->table_name . " WHERE responden_id = 4";
...
$survey = new SurveyOrtu($db);
$result = $survey->getSurveysForOrtu();
...
<head>
    ...
    <title>Survey Wali Mahasiswa</title>
                    ...
                    ?>
                        <div class="col-12 col-sm-6 col-md-4 mb-3">
                            <a href="soal.php?survey_kategori_id=<?php echo $survey_kategori_id; ?>">
                                <div class="card mb-3" style="width: 100%; height: 230px; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25) inset; border-radius: 6px; border: 1px #E6E6E6 solid; 
