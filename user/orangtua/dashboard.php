...
class Dashboard {
    ...
    public function getDashboardData() {
        $query = "SELECT first_name, last_name, picture FROM p_ortu WHERE user_id = ?";
...
<head>
    ...
    <title>Dashboard Wali Mahasiswa</title>
    ...
    <div class="wrapper">
            ...
            <div class="content d-flex justify-content-between gap-5">
                ...
                <div class="statistics ms-5">
                    ...
                    <div class="group-survey d-flex align-items-baseline gap-5">
                        <!-- <div class="card" href="soal-kualitas-pengajaran.php" style="background-image: url(../../assets/images/rating.jpg); background-size: cover; background-repeat: no-repeat;">
                            <div class="card-body d-flex">
                              <h6 class="card-title fw-semibold mt-1">Kualitas Pengajaran</h6>
                            </div>
                        </div> -->
                        <div class="card" style="background-image: url(../../assets/images/fasilitas.jpg); background-size: cover; background-repeat: no-repeat;background-position-y: -20px;">
                            <div class="card-body d-flex" href="soal-fasilitas-kampus.php">
                              <h6 class="card-title fw-semibold mt-1">Fasilitas Wali Mahasiswa</h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <aside class="me-5">
                    ...
                    <div class="group-survey d-flex flex-column gap-4">
                            <div class="card" style="background-image: url(../../assets/images/layanan.jpg); background-size: cover; background-repeat: no-repeat;">
                                <div class="card-body d-flex flex-column justify-content-between" href="soal-layanan-mahasiswa.php">
                                  <h6 class="card-subtitle fw-semibold">Layanan Administrasi</h6>
                                </div>
                            </div>
                            <div class="card" style="background-image: url(../../assets/images/administrasi.jpg); background-size: cover; background-repeat: no-repeat;background-position-y: -20px;">
                                <div class="card-body d-flex flex-column justify-content-between" href="soal-proses-administrasi.php">
                                  <h6 class="card-subtitle fw-semibold">Biaya Pendidikan</h6>
                                </div>
                            </div>
                    </div>
                </aside>
        ...
        <!-- <div class="main">
            <div class=" header d-flex justify-content-between ms-5 mt-4 mb-4 me-4">
                ...
                <a href="profil.php">
                    <img src="../../assets/images/photo-profile2.jpeg" alt="profil" width="55px" height="55px" class="rounded-circle">
                </a>
            </div>
            <hr style="border: 2px solid #e6e6e6;">
            <div class="content d-flex justify-content-between gap-5">
