...
class Profile {
    ...
    public function getProfileData() {
        $query = "SELECT first_name, last_name, jabatan, perusahaan, email, phone_number, country, city, picture FROM p_industri WHERE user_id = ?";
    ...
    public function updateProfileData($data) {
        ...
        $query = "UPDATE p_industri SET " . implode(', ', $fields) . " WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateProfilePicture($picturePath) {
        ...
        $query = "UPDATE p_industri SET picture = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateAlamat($country, $city) {
        ...
        $query = "UPDATE p_industri SET country = ?, city = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($action) {
            case 'updateProfile':
                if (isset($_POST['first_name']) || isset($_POST['last_name']) || isset($_POST['jabatan']) || isset($_POST['email']) || isset($_POST['phone_number']) ){
                    $profileData = [];
                    ...
                    if (isset($_POST['jabatan'])) $profileData['jabatan'] = $_POST['jabatan'];
            ...
            case 'updateProfilePicture':
                ...
                if (isset($_POST['perusahaan'])) {
                    $profile->updateProfileData(['perusahaan' => $_POST['perusahaan']]);
                }
...
<head>
    ...
    <title>Halaman Profil Industri</title>
...
<body>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="card border-black rounded-4 d-flex flex-row justify-content-center align-items-center mx-5 my-4 pt-lg-2 ps-4 pe-5">
                    ...
                    <p class=" role fw-light"><?php echo htmlspecialchars($profileData['perusahaan'] ?? ''); ?></p>
                    </div>
                ...
                <div class="card rounded-4 border-black mx-5 my-4 ">
                    ...
                    <div class="card-body">
                        <div class="container">
                            ...
                            <div class="row mb-4">
                                <div class="col-4">
                                    <p class="identity mb-2">Jabatan</p>
                                    <p class="fw-medium"><?php echo htmlspecialchars($profileData['jabatan'] ?? ''); ?></p>
                                </div>
                                <div class="col-4">
    ...
    <!-- Pop Up Edit -->
    <!-- MODAL EDIT Foto Profil, NIP, dan Password  -->
    <div class="modal fade" id="editpicture" tabindex="-1" aria-labelledby="editpicture" aria-hidden="true">
                ...
                <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                    <div class="modal-content">
                        <div class="modal-body d-flex justify-content-between gap-1">
                            ...
                            <input type="hidden" name="id_industri" value="<?php echo htmlspecialchars($profileData['id_industri'] ?? ''); ?>">
                            <div class="row mb-3">
                                <!-- <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group position-relative mb-3">
                                        <label for="dosen" class="mb-1 text-secondary">Industri</label>
                                    </div>
                                    <div class="form-group position-relative mb-3">
                                        <label for="perusahaan" class="mb-1 text-secondary">Perusahaan</label>
                                        <input type="text" name="perusahaan" class="form-control border-0 border-bottom rounded-0" id="perusahaan" value="<?php echo htmlspecialchars($profileData['perusahaan'] ?? ''); ?>">
                                    </div>
                                    <div class="form-group position-relative mb-3">
                                        <label for="gantipassword" class="mb-1 text-secondary" style="font-size: 12px;">Ganti Password</label>
                                        <input type="password" name="password" class="form-control border-0 border-bottom rounded-0 h-auto" id="password" name="password"  style="font-size: 12px;">
                                    </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group position-relative mb-3">
                            <label for="tahun_masuk" class="mb-1 text-secondary">Jabatan</label>
                            <input type="text" name="jabatan" class="form-control border-0 border-bottom rounded-0" id="jabatan" value="<?php echo htmlspecialchars($profileData['jabatan'] ?? ''); ?>">
                        </div>
                        <div class="form-group position-relative mb-3">
        ...
        <div class="modal fade" id="updateAlamatModal" tabindex="-1" aria-labelledby="editalamat" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    <form action="" id="formEditAlamat" method="post">
                    <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                    <input type="hidden" name="id_industri" value="<?php echo htmlspecialchars($profileData['id_industri'] ?? ''); ?>">
                    <div class="modal-header">
...
<script>
        $(document).ready(function() {
            ...
            $('#formEditPicture').submit(function(event) {
                ...
                formData.append('perusahaan', $('#perusahaan').val());
