...
class SurveyIndustri
{
    ...
    {
        $query = "SELECT survey_kategori_id, survey_judul, survey_deskripsi, background_pic FROM " . $this->table_name . " WHERE responden_id = 5";
