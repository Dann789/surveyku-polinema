...
class Profile {
    ...
    public function getProfileData() {
        $query = "SELECT first_name, last_name, email, unit, phone_number, nopeg, country, city, picture FROM p_tendik WHERE user_id = ?";
    ...
    public function updateProfileData($data) {
        ...
        $query = "UPDATE p_tendik SET " . implode(', ', $fields) . " WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateProfilePicture($picturePath) {
        ...
        $query = "UPDATE p_tendik SET picture = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateAlamat($country, $city) {
        ...
        $query = "UPDATE p_tendik SET country = ?, city = ? WHERE user_id = ?";
        $stmt = $this->conn->prepare($query);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    switch ($action) {
        case 'updateProfile':
            if (isset($_POST['first_name']) || isset($_POST['last_name'])|| isset($_POST['email']) || isset($_POST['unit'])){
                $profileData = [];
                ...
                if (isset($_POST['unit'])) $profileData['unit'] = $_POST['unit'];
        ...
        break;
            ...
            case 'updateProfilePicture':
                ...
                if (isset($_POST['nopeg'])) {
                    $profile->updateProfileData(['nopeg' => $_POST['nopeg']]);
                }
            ...
            <div class="content">
                <div class="card border-black rounded-4 d-flex flex-row justify-content-center align-items-center mx-5 my-4 pt-lg-2 ps-4 pe-5">
                    ...
                    <div class="card-body d-flex flex-column justify-content-center text-start">
                        ...
                        <p class="fw-normal">Tendik</p>
                        <p class="role fw-light" name="nopeg"><?php echo htmlspecialchars($profileData['nopeg'] ?? ''); ?></p>
                    </div>
                    ...
                    <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                        <div class="modal-content">
                            <div class="modal-body d-flex justify-content-between gap-1">
                                ...
                                <input type="hidden" name="id_tendik" value="<?php echo htmlspecialchars($profileData['id_tendik'] ?? ''); ?>">
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group position-relative mb-3">
                                            <label for="dosen" class="mb-1 text-secondary">Dosen</label>
                                        </div>
                                        <div class="form-group position-relative mb-3">
                                            <label for="nopeg" class="mb-1 text-secondary">Nomor Pegawai</label>
                                            <input type="text" name="nopeg" class="form-control border-0 border-bottom rounded-0" id="nopeg" value="<?php echo htmlspecialchars($profileData['nopeg'] ?? ''); ?>">
                                        </div>
                                        <div class="form-group position-relative mb-3">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group position-relative mb-3">
                                ...
                                <input type="text" name="unit" class="form-control border-0 border-bottom rounded-0" id="unit" value="<?php echo htmlspecialchars($profileData['unit'] ?? ''); ?>">
                            </div>
                            <div class="form-group position-relative mb-3">
...
<script>
        $(document).ready(function() {
            ...
            $('#formEditPicture').submit(function(event) {
                ...
                formData.append('nopeg', $('#nopeg').val());
