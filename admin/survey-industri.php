...
$result = $survey->getSurveysForIndustri();
?>
...
<head>
    ...
    <title>Dashboard Admin - Survey Industri</title>
        ...
        <div class="main">
            <div class=" header d-flex justify-content-between ms-5 mt-4 mb-4 me-4">
                <div class="header-info">
                    ...
                    <p class="desc mb-3">Buat Survey untuk Responden Industri</p>
                </div>
                    ...
                    ?>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                            <a href="edit-survey.php?survey_kategori_id=<?php echo $survey_kategori_id; ?>">
                                <div class="card" style="width: 100%; height: 128px; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25) inset; border-radius: 6px; border: 2px black solid; 
                        background-image: url('data:image/jpeg;base64,<?php echo htmlspecialchars($background_pic); ?>'); background-size: cover; background-repeat: no-repeat;">
